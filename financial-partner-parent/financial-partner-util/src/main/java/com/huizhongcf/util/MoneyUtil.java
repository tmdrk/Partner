...
public class MoneyUtil {
	 ...
	 * @return
	 * @author zhoujie
	 * @date 2017年12月18日 上午10:45:59
	 */
	public static String kiloFormat(Object o){
		String str;
		try{
			str = kiloFormatDiv(o,null);
		} catch (Exception e) {
			str = "--";
		}
		return str;
	 ...
	 * @return
	 * @author zhoujie
	 * @date 2017年12月18日 下午1:58:22
	 */
	public static String kiloFormatDiv(Object o,Integer i){
		String str;
		try{
			Format fm = new DecimalFormat("#,##0.00");
			str = fm.format(MathUtil.div(new BigDecimal(String.valueOf(o)), new BigDecimal(i==null?1:i)));
		} catch (Exception e) {
			str = "--";
		}
		return str;
