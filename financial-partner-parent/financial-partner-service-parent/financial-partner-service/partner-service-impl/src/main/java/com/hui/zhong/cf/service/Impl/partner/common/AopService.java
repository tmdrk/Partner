package com.hui.zhong.cf.service.Impl.partner.common;
...
public class AopService {
    ...
    @Before("execution(* com.hui.zhong.cf.service.Impl.partner.service.impl.*.*(..))")  
    ...
    @AfterThrowing(pointcut = "execution(* com.hui.zhong.cf.service.Impl.partner.service.impl.*.*(..))", throwing = "ex")  
    ...
    @AfterReturning(pointcut="execution(* com.hui.zhong.cf.service.Impl.partner.service.impl.*.*(..))", 
