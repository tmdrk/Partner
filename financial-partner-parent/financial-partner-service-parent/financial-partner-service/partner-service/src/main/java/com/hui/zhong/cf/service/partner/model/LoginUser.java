...
public class LoginUser implements Serializable {
    ...
    private String userRole;//合伙人:10,客户:20

    private String userType;//一般合伙人:10,团队管理者:20
    ...
    private String userStatus;//启用:1,停用:2
    ...
    private String isPlatformInvite;//是:1,否:0
