package hui.zhong.cf.partner.h5.interceptor;
...
public class AopController {
    ...
    @Before("execution(* hui.zhong.cf.partner.h5.controller.*.*(..))")
    ...
    @AfterThrowing(pointcut = "execution(* hui.zhong.cf.partner.h5.controller.*.*(..))", throwing = "ex")
    ...
    @AfterReturning(pointcut = "execution(* hui.zhong.cf.partner.h5.controller.*.*(..))",
