                ...
                <form>
                    <fieldset>
                        <div class="ui-form-item username">
                            <input type="tel" maxlength=11 placeholder="请输入手机号" onpaste="return false" oncontextmenu="return false" oncopy="return false" oncut="return false">
                        </div>
                        <div class="ui-form-item validate">
                            <input type="text" id="validCode" placeholder="请输入验证码"><span id="checkCode" class="validate-code">AGTS</span>
                        </div>
