...
$(function(){
    ...
    var data = [{
            ...
            "list":{
                ...
                chaEJiangJinXiShu:{
                    name:"差额奖金系数",value:"1.5%"
                },
                chaEJiangJin:{
                    name:"差额奖金(元)",value:"30.00"
                },
                chuJieXingMing:{
                    name:"出借人姓名",value:"张三"
                },
...
function domModle(item){
    return '<div class="hSegLine"></div><div class="item clearfix">'
                    ...
                    +'<p><label>差额奖金系数</label>'+item.list.chaEJiangJinXiShu.value+'</p>'
                    +'<p><label>差额奖金(元)</label>'+item.list.chaEJiangJin.value+'</p>'
