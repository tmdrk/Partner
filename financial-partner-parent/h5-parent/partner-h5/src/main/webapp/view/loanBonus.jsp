    ...
    <header class="ui-header ui-linear">
        ...
        <div class="topNavs">
            <ul class="navs navs1">
                ...
                <li>
                    <a href="javascript:void(0)"><span class="num">4</span>我的下级<b></b></a>
                </li>
            </ul>
        </div>
...
$(function(){
    ...
    var data = [{
        ...
        "list":{
            ...
            chaEJiangJinXiShu:{
                name:"出借奖金系数",value:"1.5%"
            },
            chaEJiangJin:{
                name:"出借奖金(元)",value:"30.00"
            },
            chuJieXingMing:{
                name:"出借人姓名",value:"张三"
            },
...
function domModle(item){
    return '<div class="hSegLine"></div><div class="item clearfix">'
                    ...
                    +'<p><label>出借奖金系数</label>'+item.list.chaEJiangJinXiShu.value+'</p>'
                    +'<p><label>出借奖金(元)</label>'+item.list.chaEJiangJin.value+'</p>'
