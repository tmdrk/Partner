...
<div class="hhrAll">
    <div class="ui-page">
        <div class="ui-view invite-wrap invite-custom">
            <div class="ui-register-form">
                <form>
                    <h4>注册</h4>
                    <ul>
                        <li><input type="text" placeholder="请输入手机号"></li>
                        <li><input type="text" placeholder="请输入图形验证码"><span id="checkCode" class="validate-code code-color">AGTS</span></li>
                        <li><input type="text" placeholder="请输入短信验证码"><span class="get-code" id="get-code">获取验证码</span></li>
